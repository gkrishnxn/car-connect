...
const Footer = () => {
  return (
  <footer className="bg-orange-100 mt-10">
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    Thank you for visiting and using our site. We appreciate your support and hope you find exactly what 
    you're looking for. Your satisfaction is our priority. Enjoy exploring and come back soon!
    </p>
    ...
    <ul className="mt-12 flex justify-center gap-6 md:gap-8">
      ...
      <li>
        <a
          href="https://github.com/gkrishnxn"
          rel="noreferrer"
          target="_blank"
          className="text-gray-700 transition hover:text-gray-700/75"
        >
